...
class Server:
    ...
    def handle_client(self, client_socket, addr):
        try:
            ...
            self.client_mapping[player_id] = client_socket
            ...
            while self.running:
                try:
                    ...
                    try:
                        ...
                        logging.error(f"invalid message format from {addr}")
                        error_message = {
                            "error": "invalid message format. couldnt parse."
                        }
                        send_message(error_message, client_socket, self.logger)
            ...
            del self.client_mapping[player_id]  # clean up
            client_socket.close()
